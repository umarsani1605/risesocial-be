...
import { getAllAcademiesSchema, getAcademyCategoriesSchema, getAcademyBySlugSchema } from '../../schemas/shared/academySchemas.js';
...
export default async function userAcademyRoutes(fastify) {
  ...
  fastify.get('/categories', {
    schema: getAcademyCategoriesSchema,
    handler: userAcademyController.getCategories,
  });
